<%@ Page Title="کارت سوخت مسدود شده" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="DiscardedFCs.aspx.cs" Inherits="Union_DiscardedFCs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="title-bar">
        ثبت کارت سوخت مسدود شده
    </div>
