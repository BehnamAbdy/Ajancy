...
public partial class Union_FCReplacement : System.Web.UI.Page
{
        ...
        else
        {
            ...
            if (person.DriverCertifications.Count > 0)
            {
                ...
                if (driverCertification != null)
                {
                    ...
                    {
                        DisposeContext();
                        Response.Redirect(string.Format("~/Union/SelfReplacement.aspx?id={0}", TamperProofString.QueryStringEncode(person.PersonID.ToString())));
                    }
