<%@ Page Title="ثبت پروانه کسب آژانس" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="BusinessLicense.aspx.cs" Inherits="Union_BusinessLicense" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            <table style="margin-right: 50px;">
                ...
                <tr>
                    <td class="fieldName-large">رسته شغلی :
                    </td>
                    <td>
                ...
                <tr>
                    <td class="fieldName-large">نوع پروانه کسب :
                    </td>
                    <td>
                ...
                <tr>
                    <td class="fieldName-large">نام آژانس :
                    </td>
                    <td>
                ...
                <tr>
                    <td class="fieldName-large">شماره پروانه کسب :
                    </td>
                    <td>
