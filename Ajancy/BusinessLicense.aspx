<%@ Page Title="ثبت پروانه کسب آژانس" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="BusinessLicense.aspx.cs" Inherits="Ajancy_BusinessLicense" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <center>
        <div class="title-bar">
            فرم ثبت پروانه کسب آژانس
        </div>
    </center>
        ...
        <ContentTemplate>
            <table style="margin-right: 135px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNationalCode" runat="server" SkinID="TextBoxMedium" MaxLength="10"
                            ReadOnly="true" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtAjancyName"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="نام آژانس را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtMemberShipCode" runat="server" SkinID="TextBoxMedium" MaxLength="20" />
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtMemberShipCode"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="شماره عضویت را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <asp:TextBox ID="txtNationalCardBarCode" runat="server" SkinID="TextBoxMedium" MaxLength="20" />
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="txtNationalCardBarCode"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="بارکد ملی را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <asp:TextBox ID="txtSerialNo" runat="server" SkinID="TextBoxMedium" MaxLength="20" />
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="txtSerialNo"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="شماره مسلسل را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <asp:TextBox ID="txtCategoryCode" runat="server" SkinID="TextBoxMedium" MaxLength="20" />
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="txtCategoryCode"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="شماره رسته را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <asp:TextBox ID="txtISIC" runat="server" SkinID="TextBoxMedium" MaxLength="20" />
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtISIC"
                            SetFocusOnError="true" Display="Dynamic" ErrorMessage="ISIC را وارد کنید"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <userControl:Date ID="txtStartDate" runat="server" Required="true" />
                    </td>
                </tr>
                <tr>
                    <td class="fieldName-large">
                    ...
                    <td>
                        <userControl:Date ID="txtEndDate" runat="server" Required="true" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPlacePostalCode" runat="server" MaxLength="10" SkinID="TextBoxMedium"
                            onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                        <span class="star">*</span>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="کد پستی را وارد کنید"
                            ControlToValidate="txtPlacePostalCode"></asp:RequiredFieldValidator>
                    ...
                    <td colspan="2" align="center">
                        <table id="partners">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPartnerNationalCode1" runat="server" SkinID="TextBox" MaxLength="10"
                                        onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                                    <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="*" ControlToValidate="txtPartnerNationalCode1"
                                        ClientValidationFunction="nationalCodeValidate"></asp:CustomValidator>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPartnerNationalCode2" runat="server" SkinID="TextBox" MaxLength="10"
                                        onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                                    <asp:CustomValidator ID="CustomValidator4" runat="server" ErrorMessage="*" ControlToValidate="txtPartnerNationalCode2"
                                        ClientValidationFunction="nationalCodeValidate"></asp:CustomValidator>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPartnerNationalCode3" runat="server" SkinID="TextBox" MaxLength="10"
                                        onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                                    <asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage="*" ControlToValidate="txtPartnerNationalCode3"
                                        ClientValidationFunction="nationalCodeValidate"></asp:CustomValidator>
                                </td>
                                <td>
