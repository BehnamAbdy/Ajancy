...
public partial class Academy_FCDiscard : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            if (this.ViewState["PersonID"] == null) // New Person  
            {
                ...
                driverCertification = new Ajancy.DriverCertification { CertificationType = (byte)Public.AjancyType.Academy, SubmitDate = DateTime.Now };
