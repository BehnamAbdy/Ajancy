<%@ Page Title="ابطال کارت سوخت بدون جایگزین" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="FCDiscard.aspx.cs" Inherits="Academy_FCDiscard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="title-bar">
        ابطال کارت سوخت بدون جایگزین
    </div>
