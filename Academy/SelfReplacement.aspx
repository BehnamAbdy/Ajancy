<%@ Page Title="ابطال و جایگزین کارت سوخت" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="SelfReplacement.aspx.cs" Inherits="Academy_SelfReplacement" %>
            ...
            <table>
                <tr>
                    <td class="section-title">
                        مشخصات کارت سوخت آموزشگاهی (ابطالی)
                    </td>
                    <td class="section-title">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="star">*</span>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="آموزشگاه را انتخاب کنید"
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="star">*</span>
                                    <asp:CompareValidator ID="CompareValidator6" runat="server" ErrorMessage="آموزشگاه را انتخاب کنید"
