<%@ Page Title="لیست آموزشگاه های رانندگی" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="Academies.aspx.cs" Inherits="Academy_Academies" %>
                    ...
                    <ItemTemplate>
                        <table class="list-item-even">
                            <tr>
                                ...
                                <td>
                                    <a class="item-box" style="float: none;" href='<%#string.Format("../Academy/BusinessLicense.aspx?j={0}", TamperProofString.QueryStringEncode(Eval("AjancyID").ToString()))%>'
