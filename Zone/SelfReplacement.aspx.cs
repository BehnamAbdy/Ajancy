...
public partial class Zone_SelfReplacement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                DisposeContext();
                Response.Redirect("~/Union/FCReplacement.aspx");
            }
    ...
    private void SelfReplacement_Edit()
    {
        ...
        Ajancy.ZonePlateNumber plateNumber_2 = carPlateNumber_2.ZonePlateNumber;
