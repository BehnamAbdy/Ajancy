<%@ Page Title="ابطال و جایگزین کارت سوخت" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="SelfReplacement.aspx.cs" Inherits="Zone_SelfReplacement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <center>
        <div class="title-bar">
            ابطال و جایگزین کارت سوخت - پلاک منطقه آزاد
        </div>
    </center>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table>
                <tr>
                    <td class="section-title">مشخصات کارت سوخت آژانسی (ابطالی)
                    </td>
                    <td class="section-title">مشخصات کارت سوخت شخصی (جایگزینی)
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            ...
                            <tr>
                                <td class="fieldName">PAN کارت سوخت :
                                </td>
                                <td>
                        ...
                        <table>
                            <tr>
                                <td class="section-title" colspan="2">مالک خودرو (درصورتی پرشود که مالک خودرو شخصی غیر از بهره بردار باشد)
                                </td>
                            </tr>
                            <tr>
                                <td class="fieldName">کد ملی :
                    ...
                    <td>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCarPlateNumber_5_2" runat="server" SkinID="TextBoxMedium" MaxLength="5"
                                        Width="40px" onkeypress="javascript:return isNumberKey(event)"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*"
                                        ControlToValidate="txtCarPlateNumber_5_2"></asp:RequiredFieldValidator>

                                </td>
                                <td>
                                    <asp:DropDownList ID="drpCarPlateNumberCity_2" runat="server" CssClass="dropdown" DataTextField="Name"
                                        DataValueField="CityID">
                                    </asp:DropDownList>
                                    <asp:CompareValidator ID="CompareValidator11" runat="server" ErrorMessage="*"
                                        ControlToValidate="drpCarPlateNumberCity_2" ValueToCompare="0" Operator="GreaterThan" Type="Integer"></asp:CompareValidator>
                                </td>
                                <td>
                                    <asp:DropDownList ID="drpCarPlateNumberProvince_2" runat="server" CssClass="dropdown" AutoPostBack="true"
                                        OnSelectedIndexChanged="drpCarPlateNumberProvince_2_SelectedIndexChanged">
                                        <asp:ListItem Value="0" Text="- استان -" />
                                        <asp:ListItem Value="41" Text="آذربايجان شرقي" />
                                        <asp:ListItem Value="44" Text="آذربايجان غربي" />
                                        <asp:ListItem Value="45" Text="اردبيل" />
                                    ...
                                    <asp:CompareValidator ID="CompareValidator12" runat="server" ErrorMessage="*"
                                        ControlToValidate="drpCarPlateNumberProvince_2" ValueToCompare="0" Operator="GreaterThan" Type="Integer"></asp:CompareValidator>
                                </td>
                            </tr>
                        </table>
                        <table>
