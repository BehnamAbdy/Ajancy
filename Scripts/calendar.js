...
function drawDatePicker(targetDateField, x, y)
{
    ...
    if (!isDate(targetDateField.value))
    {
        var today = getTodayPersian();
        refreshDatePicker(targetDateField, today[0], today[1], today[2]);
    }
    else
...
function refreshDatePicker(dateFieldName, year, month, day)
{
    ...
    {
        TD_onclick = " onclick=\"updateDateField('" + (typeof (dateFieldName) == "string" ? dateFieldName : dateFieldName.id) + "', '" + getDateString(thisDay) + "');\">";
    ...
    var today = getTodayPersian();
    html += "<button class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\"," + today[0] + "," + today[1] + "," + today[2] + ");'>&#1575;&#1605;&#1585;&#1608;&#1586;</button> ";
...
function updateDateField(dateFieldName, dateString)
{
    ...
    if (dateString && targetDateField != null)
        targetDateField.value = dateString;
    else
        dateFieldName.value = dateString;
