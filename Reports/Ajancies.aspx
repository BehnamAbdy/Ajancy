<%@ Page Title="آژانس های دارای پروانه کسب" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="Ajancies.aspx.cs" Inherits="Reports_Ajancies" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            <table class="centered">
                ...
                <tr>
                    <td class="fieldName-large">نوع آژانس :
                    </td>
                    <td>
            ...
            <table style="margin-right: 125px;">
                <tr>
                    <td align="left">
                    ...
                    <LayoutTemplate>
                        <table id="list-header">
                            <tr>
                                ...
                                <th style="width: 150px;">مدیر
                                </th>
                                <th>تاریخ ثبت درسیستم
                                </th>
                                <th>شماره پروانه کسب
                                </th>
                                <th>شهر
                    ...
                    <ItemTemplate>
                        <table class="list-item-even">
                            <tr>
                                ...
                                <td>
                                    <a class="item-box" style="float: none;" href='<%#string.Format("../Union/BusinessLicense.aspx?j={0}", TamperProofString.QueryStringEncode(Eval("AjancyID").ToString()))%>'
