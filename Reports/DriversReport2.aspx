<%@ Page Title="گزارش آمار ثبت رانندگان" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="DriversReport2.cs" Inherits="Reports_DriversReport2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <center>
        <div class="title-bar">
            گزارش آمار ثبت رانندگان
        </div>
    </center>
        ...
        <ContentTemplate>
            <table style="margin-right: 90px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpCarType" runat="server" CssClass="dropdown-middle" DataTextField="TypeName" DataValueField="CarTypeID">
                        </asp:DropDownList>
                    </td>
                </tr>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OnSelecting="ObjectDataSource1_Selecting"
                SelectCountMethod="GetDriversCount2" SelectMethod="LoadDrivers2" TypeName="Paging"
        ...
        function deleteDriver(item, pId) {
            if (confirm('آیا راننده مورد نظر به همراه کلیه سوابق و اطلاعاتش از سیستم حذف گردد؟')) {
                $.ajax({
                    ...
                    url: '../Reports/DriversReport2.aspx',
                    dataType: 'json',
                    cache: false,
