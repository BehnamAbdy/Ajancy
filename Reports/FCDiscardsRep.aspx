<%@ Page Title="گزارش کارت سوخت های خطی و بین راهی" Language="C#" MasterPageFile="~/SiteWide.master"
    AutoEventWireup="true" CodeFile="FCDiscardsRep.aspx.cs" Inherits="Reports_FCDiscardsRep" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <center>
        <div class="title-bar">
            گزارش کارت سوخت های خطی و بین راهی
        </div>
    </center>
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            <table style="margin: 0px auto;">
                ...
                <tr>
                    <tr>
                        <td class="fieldName-large">کدملی مالک خودرو :
                        </td>
                        <td colspan="3">
                    ...
                    <ItemTemplate>
                        <table class="list-item-even">
                            <tr>
                                ...
                                <td>
                                    <%#((short?)Eval("ZCityID")).HasValue?string.Format("{0} {1}",Eval("ZNumber"),Eval("ZCity")): Public.PlateNumberRenderToHTML(Eval("TwoDigits").ToString(), Eval("Alphabet").ToString(), Eval("ThreeDigits").ToString(), Eval("RegionIdentifier").ToString())%>
                                </td>
                                <td>
                                    <%#Eval("AjancyName")%>
                                </td>
                                ...
                                <td style="width: 30px;">
                                    <span class="info" style="float: none;" onclick="javascript:deleteReq(this, '<%#Eval("FuelCardSubstituteID")%>')">حذف</span>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" OnSelecting="ObjectDataSource1_Selecting"
                SelectCountMethod="GetFCDiscardsCount" SelectMethod="LoadFCDiscards" TypeName="Paging"
